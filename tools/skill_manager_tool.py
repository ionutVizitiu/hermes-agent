...
``skills.create_dir`` (or legacy ``skills.creation_dir``) when configured,
otherwise ``~/.hermes/skills/``.
...
# writable creation target while keeping hub-installed skills in ~/.hermes/skills/.
